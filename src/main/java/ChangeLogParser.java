...
public class ChangeLogParser extends Parser {
    ...
    public static class ChangelogContext extends ParserRuleContext {
        public TerminalNode BEGINCL() {
            return getToken(ChangeLogParser.BEGINCL, 0);
        }
        ...
        public TerminalNode NEWLINE() {
            return getToken(ChangeLogParser.NEWLINE, 0);
        }
        ...
        public TerminalNode ENDCL() {
            return getToken(ChangeLogParser.ENDCL, 0);
        }
    ...
    public static class AuthorContext extends ParserRuleContext {
        public List<TerminalNode> TEXT() {
            return getTokens(ChangeLogParser.TEXT);
        }
        ...
        public List<TerminalNode> DIGITS() {
            return getTokens(ChangeLogParser.DIGITS);
        }
        ...
        public List<TerminalNode> PUNCTUATION() {
            return getTokens(ChangeLogParser.PUNCTUATION);
        }
    ...
    public static class EntryContext extends ParserRuleContext {
        public TerminalNode TAG() {
            return getToken(ChangeLogParser.TAG, 0);
        }
        ...
        public List<TerminalNode> WHITESPACE() {
            return getTokens(ChangeLogParser.WHITESPACE);
        }
    ...
    public static class WhitespaceContext extends ParserRuleContext {
        public TerminalNode WHITESPACE() {
            return getToken(ChangeLogParser.WHITESPACE, 0);
        }
